...
export class CardAnalyticsComponent implements OnInit, OnDestroy {
   ...
   */
  ngOnInit() {
    this._cardAnalyticsService.onCardAnalyticsChanged
      ...
      if (
        ...
        setTimeout(() => {
          ...
          this.supportChartoptions.chart.width =
            this.supportChartoptionsRef?.nativeElement.offsetWidth;
          this.avgsessionChartoptions.chart.width =
            this.avgsessionChartoptionsRef?.nativeElement.offsetWidth;
          this.revenueReportChartoptions.chart.width =
            this.revenueReportChartoptionsRef?.nativeElement.offsetWidth;
          this.budgetChartoptions.chart.width =
            this.budgetChartoptionsRef?.nativeElement.offsetWidth;
          this.goalChartoptions.chart.width =
            this.goalChartoptionsRef?.nativeElement.offsetWidth;
          ...
          this.salesavgChartoptions.chart.width =
            this.salesavgChartoptionsRef?.nativeElement.offsetWidth;
          this.sessionChartoptions.chart.width =
            this.sessionChartoptionsRef?.nativeElement.offsetWidth;
          this.customerChartoptions.chart.width =
            this.customerChartoptionsRef?.nativeElement.offsetWidth;
          ...
          this.earningChartoptions.chart.width =
            this.earningChartoptionsRef?.nativeElement.offsetWidth;
        }, 500);
      }
    });
  }
