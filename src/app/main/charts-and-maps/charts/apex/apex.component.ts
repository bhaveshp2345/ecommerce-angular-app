...
export class ApexComponent implements OnInit {
  ...
  constructor(private _coreConfigService: CoreConfigService) {
    ...
    this.apexLineAreaChart = {
      ...
      colors: [
        this.chartColors.area.series1,
        this.chartColors.area.series2,
        this.chartColors.area.series3,
      ],
      dataLabels: {
        enabled: false,
      },
    ...
    this._coreConfigService.getConfig().subscribe((config) => {
      ...
      if (
        ...
        setTimeout(() => {
          ...
          this.apexScatterChart.chart.width =
            this.apexScatterChartRef?.nativeElement.offsetWidth;
          this.apexCandlestickChart.chart.width =
            this.apexCandlestickChartRef?.nativeElement.offsetWidth;
          this.apexHeatmapChart.chart.width =
            this.apexHeatmapChartRef?.nativeElement.offsetWidth;
          this.apexRadarChart.chart.width =
            this.apexRadarChartRef?.nativeElement.offsetWidth;
